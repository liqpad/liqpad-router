...
contract SmokeSellForUSDC is LiqpadSmokeBase {
    ...
    function run() external {
        ...
        uint256 usdcOut = router.swapExactB20ForUSDC(
            B20,
            amountIn,
            vm.envOr("SMOKE_MIN_VVV_SELL", uint256(1)),
            vm.envOr("SMOKE_MIN_USDC_SELL", uint256(1)),
            account,
        ...
        console2.log("USDC received", usdcOut);
    }
}
